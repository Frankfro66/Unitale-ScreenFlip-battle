...
possible_attacks = {"flip", "bullettest_bouncy", "bullettest_chaserorb", "bullettest_touhou"}

function EncounterStarting()
    -- If you want to change the game state immediately, this is the place.
	require "Anim/flip"
	SetGlobal("dir",1) -- if "dir" == 1 then screen is normal, if else then its upside down
end
...
function EnemyDialogueEnding()
    ...
    nextwaves = {"flip"}
SetGlobal("dir",2)
	flip()-- flips the screen, look at the waves file
end
